...
public class SocialTabsActivityTst extends ExoActivityTestUtils<SocialTabsActivity> {
    ...
    public void verifyDefaultLayout() {
        ...
        assertNull("Button should not exist at pos 2", actionBar.getItem(2)); // ActionBar.getItem()
                                                                              // returns
                                                                              // null
                                                                              // when
                                                                              // there
        ...
        String[] tabsTitle = activity.getResources().getStringArray(R.array.SocialTabs); // check
                                                                                         // each
                                                                                         // tab's
                                                                                         // title
    ...
    public void shouldFinishActivity() {
        ...
        ImageButton homeBtn = (ImageButton) actionBar.getChildAt(0); // home
                                                                     // button
                                                                     // is the
                                                                     // 1st
                                                                     // child of
