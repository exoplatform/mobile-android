...
public class ServerEditionActivityTest extends ExoActivityTestUtils<ServerEditionActivity> {
    ...
    public void verifyEditOneAccount() {
        ...
        assertThat("1 server should already exist", ServerSettingHelper.getInstance()
                                                                       .getServerInfoList(ctx)
                                                                       .size(), equalTo(1));
        ...
        assertThat("Only 1 server should exist", ServerSettingHelper.getInstance()
                                                                    .getServerInfoList(ctx)
                                                                    .size(), equalTo(1));
        assertTrue("Should have displayed toast ServerUpdated but displayed '"
                           + ShadowToast.getTextOfLatestToast() + "' instead.",
    ...
    public void verifyDeleteOneAccount() {
        ...
        assertThat("Server should have been deleted", ServerSettingHelper.getInstance()
                                                                         .getServerInfoList(ctx)
                                                                         .size(), equalTo(0));
        assertTrue("Should have displayed toast ServerDeleted but displayed '"
                           + ShadowToast.getTextOfLatestToast() + "' instead.",
    ...
    public void verifyEditAccountFailsWithIncorrectAccountName() {
        ...
        assertThat("Account name should NOT have been modified",
                   srv.accountName,
                   equalTo(TEST_SERVER_NAME));
        assertTrue("Should have displayed toast AccountNameInvalid but displayed '"
                           + ShadowToast.getTextOfLatestToast() + "' instead.",
                   ShadowToast.showedToast(ctx.getResources()
                                              .getString(R.string.AccountNameInvalid)));
    }
    ...
    public void verifyEditAccountFailsWithIncorrectAccountServer() {
        ...
        assertThat("Account Server URL should NOT have been modified",
                   srv.serverUrl,
                   equalTo(TEST_SERVER_URL));
        assertTrue("Should have displayed toast AccountServerInvalid but displayed '"
                           + ShadowToast.getTextOfLatestToast() + "' instead.",
                   ShadowToast.showedToast(ctx.getResources()
                                              .getString(R.string.AccountServerInvalid)));
    }
    ...
    public void verifyEditAccountFailsWithForbiddenAccountServer() {
        ...
        assertThat("Account Server URL should NOT have been modified",
                   srv.serverUrl,
                   equalTo(TEST_SERVER_URL));
        assertTrue("Should have displayed toast AccountServerForbidden but displayed '"
                           + ShadowToast.getTextOfLatestToast() + "' instead.",
                   ShadowToast.showedToast(ctx.getResources()
                                              .getString(R.string.AccountServerForbidden)));
    }
    ...
    public void verifyEditAccountFailsWithIncorrectAccountUserName() {
        ...
        assertThat("Account username should NOT have been modified",
                   srv.username,
                   equalTo(TEST_USER_NAME));
        assertTrue("Should have displayed toast AccountUsernameInvalid but displayed '"
                           + ShadowToast.getTextOfLatestToast() + "' instead.",
                   ShadowToast.showedToast(ctx.getResources()
                                              .getString(R.string.AccountUsernameInvalid)));
    }
    ...
    public void verifyAccountIsSelectedWhenOnlyOneRemainsAfterDelete() {
        ...
        assertTrue("The 2nd account should have been selected automatically when the 1st was deleted",
                   acc2.equals(remainingAcc));
