...
public class ExoAccountInfoValidationTest {
    ...
    public void testForbiddenTenantNames() {
        ...
        final String[] CLOUD_URLS_FORBIDDEN = { "http://exoplatform.net",
    ...
    public void testShouldValidateCorrectEmails() {
        ...
        final String[] EMAILS_OK = { "test@example.com", "test.test@example.com",
                "test-test@example.com", "test_test@example.com", "test+test@example.com",
    ...
    public void testShouldNotValidateIncorrectEmailsAndNull() {
        ...
        final String[] EMAILS_INCORRECT = { "example.com", "@example.com", "test", "test@",
                "test@.com" };
    ...
    public void testShouldValidateCorrectURLs() {
        ...
        final String[] URLS_OK = { "test.com", "test.example.com", "test-example.com", "test.fr",
                "test.info", "test.org", "test.net", "test.co.uk", "http://test.com",
                "https://test.com", "t.e.s.t.com", "10.100.10.1", "test.com:80", "test123.com",
    ...
    public void testShouldNotValidateIncorrectURLsAndNull() {
        ...
        final String[] URLS_INCORRECT = { "test.", ".com", "http://test{}.com",
                "https://test().com", "test[].com", "test!.com", "test@.com", "test#.com",
                "test$.com", "test&.com", "test*.com", "test|.com", "test~.com",
                "test example.com", "test_example.com", "http:test-example.org",
                "http//test-example.org", "0.0.0.0", "300.10.100.200", "test.10.20.30" };
    ...
    public void testShouldStripCorrectURLs() {
        ...
        String[] HTTP_URLS = { "test.com", "http://test.com", "test.com/some/long/path/",
                "http://test.com/shortpath/", "http://test.com/index.html" };

        for (String string : HTTP_URLS) {
            String url = ExoUtils.stripUrl(string);
            assertThat("URL '" + string + "' should have been stripped to " + expectedUrl,
                       url,
                       equalTo(expectedUrl));
        }

        expectedUrl = "https://test.com";
        String[] HTTPS_URLS = { "https://test.com", "https://test.com/some/long/path/",
                "https://test.com/shortpath/", "https://test.com/index.html" };
        ...
        assertThat("URL '" + myURL + "' should have been stripped to " + expectedUrl,
                   url,
                   equalTo(expectedUrl));
    ...
    public void testAccountsAreEqual() {
        ...
        account1.username = "";
        account2.username = "";
        assertTrue("Account 1 and 2 should be equal with empty usernames",
                   account1.equals(account2));

        // different passwords
        account1.password = "password";
        account2.password = "other-password";
        assertTrue("Account 1 and 2 should be equal with different passwords",
                   account1.equals(account2));

        // different auto login option
        account1.isAutoLoginEnabled = true;
        account2.isAutoLoginEnabled = false;
        assertTrue("Account 1 and 2 should be equal with different auto login option",
                   account1.equals(account2));

        // different remember me option
        account1.isRememberEnabled = true;
        account2.isRememberEnabled = false;
        assertTrue("Account 1 and 2 should be equal with different remember me option",
                   account1.equals(account2));
    ...
    public void testAccountsAreNotEqual() {
        ...
        account1.username = "testuser";
        account2.username = "testuser";
        assertFalse("Account 1 and 2 should be different, server names are not equal",
                    account1.equals(account2));
        ...
        account1.username = "testuser";
        account2.username = "testuser";
        assertFalse("Account 1 and 2 should be different, URLs are not equal",
                    account1.equals(account2));
        ...
        assertFalse("Account 1 and 2 should be different, usernames are not equal",
                    account1.equals(account2));
