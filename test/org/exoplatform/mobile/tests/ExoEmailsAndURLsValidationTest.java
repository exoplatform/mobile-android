...
public class ExoEmailsAndURLsValidationTest {
    ...
    final String[] EMAILS_OK            = { "test@example.com", "test.test@example.com",
            ...
            "test@test.example.com", "test@test-example.com", "test@test_example.com"
                                        // "test@example" disabled although it
                                        // should be valid (TODO)
                                        };

    final String[] EMAILS_INCORRECT     = { "example.com", "@example.com", "test", "test@"
                                        // "test@.com" disabled although it
                                        // should be incorrect (TODO)
                                        };

    final String[] URLS_OK              = { "test.com", "test.example.com", "test-example.com",
            "test.fr", "test.info", "http://test.com", "https://test.com", "t.e.s.t.com",
            "10.100.10.1", "test.com:80", "test123.com", "www.test.com/some/path"
                                        // "test"
                                        // "test_example.com"
                                        };

    final String[] URLS_INCORRECT       = { "test.", ".com", "test{}.com", "test().com",
            "test[].com", "test!.com", "test@.com", "test#.com", "test$.com", "test&.com",
            "test*.com", "test|.com", "test~.com", "test example.com", };
    ...
    public void testForbiddenTenantNames_ExoConnectionUtils() {
        ...
        for (String string : CLOUD_URLS_FORBIDDEN) {
            assertTrue(string + " should be forbidden",
                       ExoConnectionUtils.urlHasWrongTenant(string));
        }
    ...
    // for (String string : URLS_INCORRECT) {
    // String newUrl = a.parserURL(string);
    // assertFalse(newUrl+" should be incorrect",
    // URLAnalyzer.isValidUrl(newUrl));
    // }
    //
    // }
