...
public class DocumentLoadTask extends AsyncTask<Integer, Void, Integer> {
    ...
    public Integer doInBackground(Integer... params) {
        ...
        try {
            /*
             * Checking the session status each time we retrieve files/folders.
             * If time out, re logging in. If relogging in error, pop up a error
             * dialog
             */
            String versionUrl = SocialActivityUtil.getDomain()
                    + ExoConstants.DOMAIN_PLATFORM_VERSION;
            ...
            case DocumentActivity.ACTION_ADD_PHOTO:
                ...
                if (tempFile != null) {
                    result = ExoDocumentUtils.putFileToServerFromLocal(strSourceUrl + "/"
                                                                               + file.getName(),
                                                                       tempFile,
