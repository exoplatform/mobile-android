 ...
 */
public abstract class SocialLoadTask extends
                                    AsyncTask<Integer, Void, ArrayList<SocialActivityInfo>> {
     ...
     * position of the activity from which to load more activities (params[2]).
