...
public class ActivityLoadTask extends UserTask<Integer, Void, ArrayList<ExoSocialActivity>> {
  ...
  public ActivityLoadTask(Context context,SocialController controller) {
    mContext = context;
