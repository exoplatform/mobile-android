...
public class ActivityDetailLoadTask extends UserTask<Void, Void, Integer> {
  ...
  public ActivityDetailLoadTask(Context context, SocialDetailController controller) {
    mContext = context;
  ...
  public void onPostExecute(Integer result) {
    if (result == 1) {
      ...
      String title = selectedRestActivity.getTitle();
      long postedTime = selectedRestActivity.getPostedTime();
