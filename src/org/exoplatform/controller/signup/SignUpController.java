...
public class SignUpController {
    ...
    public class SignUpTask extends AsyncTask<Void, Void, Integer> {
        ...
        public Integer doInBackground(Void... params) {
            ...
            try {
                ...
                // response 400 - invalid format for email address - do not
                // handle
        ...
        public void onPostExecute(Integer result) {
            ...
            case ExoConnectionUtils.SIGNUP_INVALID:
                mWarningDialog = new SignUpWarningDialog(mContext,
                                                         warningTitle,
                                                         invalidMess,
                                                         OkMess);
    ...
    private class SignUpWarningDialog extends WarningDialog {
        ...
        public SignUpWarningDialog(Context context,
                                   String titleString,
