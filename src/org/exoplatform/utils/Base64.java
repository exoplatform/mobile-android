...
public class Base64 {
    ...
    public static byte[] decodeFromFile(String filename) {
        ...
        try {
            ...
            if (file.length() > Integer.MAX_VALUE) {
                Log.d(TAG, "File is too big for this convenience method (" + file.length()
                        + " bytes).");
                return null;
            ...
            Log.d(TAG,
                  "Error decoding from file " + filename + " - IOException : "
    ...
    public static String encodeFromFile(String filename) {
        ...
        try {
            ...
            Log.d(TAG,
                  "Error encoding from file " + filename + " - IOException : "
                          + e.getLocalizedMessage());
        } // end catch: IOException
        finally {
            try {
