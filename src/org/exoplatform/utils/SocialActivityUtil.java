...
public class SocialActivityUtil {
    ...
    public static float getPlatformVersion() {
        ...
        return Float.parseFloat(ServerSettingHelper.getInstance()
                                                   .getServerVersion()
                                                   .substring(0, 3));
    }
    ...
    public static String getActivityTypeWiki(String userName,
        ...
        if (act_key != null) {
            ...
            if (getPlatformVersion() >= 4.0f) {
                /*
                 * on PLF4 we have editPageContent and editPageTitle action
                 * instead of update_page
                 */
                if (act_key.equalsIgnoreCase("editPageContent")
                        || act_key.equalsIgnoreCase("editPageTitle")) {
    ...
    public static String getActivityTypeAnswer(String userName,
        ...
        if (getPlatformVersion() >= 4.0f) {
            /*
             * on PLF 4, currently we do not have act_key so no way to
             * distinguish QuestionAdd, QuestionUpdate or AnswerAdd
             */
