 ...
 */
public class SocialActivityStreamItem extends LinearLayout implements OnTouchListener{
	...
	public SocialActivityStreamItem(Context context, SocialActivityInfo info, boolean is) {
		...
		textViewName.setOnTouchListener(this);
