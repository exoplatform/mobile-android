...
//     * canvas.drawLine(padding + 1, padding + 1, getWidth() - padding, padding +
//     * 1, mPaint); canvas.drawLine(getWidth() - padding, padding + 1, getWidth()
//     * - padding, padding + radius, mPaint); canvas.drawLine(padding + 1,
//     * padding + 1, padding + 1, getHeight() - padding, mPaint);
//     * canvas.drawLine(padding + 1, getHeight() - padding, padding + radius,
//     * getHeight() - padding, mPaint);
//     **/
//  }
//
