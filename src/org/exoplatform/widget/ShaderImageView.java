...
public class ShaderImageView extends AsyncImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // comment out this to avoid bizarre bug on api >= 17 - no blurry edge
        // effect
        /**
         * mPaint.setColor(SHADOW_COLOR); mPaint.setStyle(Paint.Style.STROKE);
         * mPaint.setStrokeJoin(Join.ROUND); mPaint.setStrokeCap(Cap.ROUND);
         * canvas.drawLine(padding + 1, padding + 1, getWidth() - padding,
         * padding + 1, mPaint); canvas.drawLine(getWidth() - padding, padding +
         * 1, getWidth() - padding, padding + radius, mPaint);
         * canvas.drawLine(padding + 1, padding + 1, padding + 1, getHeight() -
         * padding, mPaint); canvas.drawLine(padding + 1, getHeight() - padding,
         * padding + radius, getHeight() - padding, mPaint);
         **/
    }
