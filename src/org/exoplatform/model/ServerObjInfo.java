 ...
 * credentials. A server object information is identified by a pair of server's
 * url and username
 */
public class ServerObjInfo implements Parcelable {
    ...
    public boolean equals(Object obj) {
        if (!(obj instanceof ServerObjInfo))
            return false;
        ServerObjInfo _server = (ServerObjInfo) obj;
        if (_server.serverUrl.equals(serverUrl) && _server.username.equals(username))
            return true;
        return false;
    }
