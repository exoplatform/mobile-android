...
public class HomeActivity extends MyActionBar {
    ...
    /**
     * The account switcher button in the action bar. It is null if only 1
     * account exists
     */
    ...
    private void initActionBar() {
        ...
        addActionBarItem();
        super.getActionBar()
             .getItem(mAccountSwitcherBtn != null ? 2 : 1)
             .setDrawable(R.drawable.action_bar_logout_button);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putParcelable(ExoConstants.SERVER_SETTING_HELPER,
    ...
    public void setProfileInfo(String[] profile) {
        homeUserAvatar.setAnimation(AnimationUtils.loadAnimation(this,
                                                                 R.anim.home_anim_right_to_left));
