...
public class ServerEditionActivity extends Activity {
    ...
    private TextWatcher onServerNameOrServerUrlChanged() {
        return new TextWatcher() {
            ...
            public void onTextChanged(CharSequence charSequence, int i, int i2, int i3) {
                ...
                if (mIsAddingServer)
                    mOkBtn.setOnClickListener(onAddServer());
                else
    ...
    private View.OnClickListener onDeleteServer() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<ServerObjInfo> listServer = ServerSettingHelper.getInstance()
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((serverIdx != mServerIdx) && (serverIdx != -1)) {
                    Toast.makeText(ServerEditionActivity.this,
                                   mResources.getString(R.string.WarningServerUrlAndUserAlreadyExist),
                                   Toast.LENGTH_SHORT)
                         .show();
                    return;
                }
    ...
    private View.OnClickListener onAddServer() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                onSave();
                Toast.makeText(ServerEditionActivity.this,
                               mResources.getString(R.string.ServerAdded),
                               Toast.LENGTH_SHORT).show();
    ...
    private boolean isServerValid(ServerObjInfo myServerObj) {
        ...
        if (ExoDocumentUtils.isContainSpecialChar(myServerObj.serverName,
            ...
            Toast.makeText(this,
                           mResources.getString(R.string.SpecialCharacters),
                           Toast.LENGTH_SHORT).show();
            return false;
        }
        return true;
     ...
     */
    private void onSave() {
        ArrayList<ServerObjInfo> listServer = ServerSettingHelper.getInstance()
