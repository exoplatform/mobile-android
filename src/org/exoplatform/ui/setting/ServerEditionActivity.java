...
public class ServerEditionActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        /*
         * allowing to click on OK only if server name and server url are
         * inputted
         */
    ...
    private View.OnClickListener onDeleteServer() {
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                List<ExoAccount> listServer = ServerSettingHelper.getInstance()
                                                                 .getServerInfoList(ServerEditionActivity.this);
                ...
                Toast.makeText(ServerEditionActivity.this,
                               mResources.getString(R.string.ServerDeleted),
        ...
        return new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if ((serverIdx != mServerIdx) && (serverIdx != -1)) {
                    Toast.makeText(ServerEditionActivity.this,
                                   mResources.getString(R.string.WarningServerAlreadyExists),
                                   Toast.LENGTH_LONG).show();
                    return;
                }
                listServer.remove(mServerIdx);
                listServer.add(mServerIdx, newAccount);
                if (String.valueOf(mServerIdx)
                          .equals(AccountSetting.getInstance().getDomainIndex())) {
                ...
                onSave();
                Toast.makeText(ServerEditionActivity.this,
                               mResources.getString(R.string.ServerUpdated),
                               Toast.LENGTH_SHORT).show();
    ...
    private void autoSelectLastAccount() {
        List<ExoAccount> listAccounts = ServerSettingHelper.getInstance()
                                                           .getServerInfoList(ServerEditionActivity.this);
    ...
    private boolean isServerValid(ExoAccount myServerObj) {
        ...
        if (myServerObj.accountName == null || myServerObj.serverUrl == null
            ...
            Toast.makeText(this,
                           mResources.getString(R.string.WarningServerNameIsEmpty),
                           Toast.LENGTH_LONG).show();
            isValid = false;
        }
        ...
        if (!ExoUtils.isServerNameValid(myServerObj.accountName)) {
            Toast.makeText(this,
                           mResources.getString(R.string.AccountNameInvalid),
                           Toast.LENGTH_LONG).show();
            isValid = false;
        }
        ...
        if (!ExoUtils.isUrlValid(myServerObj.serverUrl)) {
            Toast.makeText(this,
                           mResources.getString(R.string.AccountServerInvalid),
                           Toast.LENGTH_LONG).show();
            isValid = false;
        }
        ...
        if (ExoUtils.isURLForbidden(myServerObj.serverUrl)) {
            Toast.makeText(this,
                           mResources.getString(R.string.AccountServerForbidden),
                           Toast.LENGTH_LONG).show();
            isValid = false;
        }
        ...
        if (myServerObj.username != null && myServerObj.username.length() > 0) {
            if (!ExoUtils.isUsernameValid(myServerObj.username)) {
                Toast.makeText(this,
                               mResources.getString(R.string.AccountUsernameInvalid),
                               Toast.LENGTH_LONG).show();
                isValid = false;
            }
        }
     ...
     */
    private void onSave() {
        ArrayList<ExoAccount> listServer = ServerSettingHelper.getInstance()
                                                              .getServerInfoList(this);
