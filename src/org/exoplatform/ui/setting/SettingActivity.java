...
public class SettingActivity extends MyActionBar implements OnClickListener, CheckBox.ViewListener {
  ...
  private CheckBoxWithImage   mEnCbx, mFrCbx, mDeCbx, mEsCbx, mPtBrCbx, mElCbx;
  ...
  private void initSubViews() {
    ...
    if (mSetting.isRememberMeEnabled()) {
      ...
      mAutoLoginCbx.setText(mResources.getString(R.string.Autologin)).setChecked(false, false).setViewListener(this);
      mAutoLoginCbx.enabled(false);
    }

    /** Languages */
    mEnCbx = (CheckBoxWithImage) findViewById(R.id.setting_en_ckb);
    mEnCbx.setText(mResources.getString(R.string.English)).setViewListener(this);

    mFrCbx = (CheckBoxWithImage) findViewById(R.id.setting_fr_ckb);
    mFrCbx.setHeadImage(R.drawable.settingslanguagefrench).setText(mResources.getString(R.string.French)).setViewListener(this);

    mDeCbx = (CheckBoxWithImage) findViewById(R.id.setting_de_ckb);
    mDeCbx.setHeadImage(R.drawable.settingslanguagegerman).setText(mResources.getString(R.string.German)).setViewListener(this);

    mEsCbx = (CheckBoxWithImage) findViewById(R.id.setting_es_ckb);
    mEsCbx.setHeadImage(R.drawable.settingslanguagespain).setText(mResources.getString(R.string.Spanish)).setViewListener(this);

    mPtBrCbx = (CheckBoxWithImage) findViewById(R.id.setting_pt_br_ckb);
    mPtBrCbx.setHeadImage(R.drawable.settingslanguagebrazil)
            .setText(mResources.getString(R.string.PortugueseBrazil))
            .setViewListener(this);

    mElCbx = (CheckBoxWithImage) findViewById(R.id.setting_el_ckb);
    mElCbx.setHeadImage(R.drawable.settingslanguagegreek).setText(mResources.getString(R.string.Greek)).setViewListener(this);

    String currentLanguage = getCurrentLanguage();
    if (currentLanguage.equalsIgnoreCase(ExoConstants.ENGLISH_LOCALIZATION))
      mEnCbx.setChecked(true, false);
    else if (currentLanguage.equalsIgnoreCase(ExoConstants.FRENCH_LOCALIZATION))
      mFrCbx.setChecked(true, false);
    else if (currentLanguage.equalsIgnoreCase(ExoConstants.GERMAN_LOCALIZATION))
      mDeCbx.setChecked(true, false);
    else if (currentLanguage.equalsIgnoreCase(ExoConstants.SPANISH_LOCALIZATION))
      mEsCbx.setChecked(true, false);
    else if (currentLanguage.equalsIgnoreCase(ExoConstants.BRAZIL_LOCALIZATION))
      mPtBrCbx.setChecked(true, false);
    else if (currentLanguage.equalsIgnoreCase(ExoConstants.GREEK_LOCALIZATION))
  ...
  private void onChangeLanguage(String language) {
    ...
    mPtBrCbx.setText(mResources.getString(R.string.PortugueseBrazil));
    mElCbx.setText(mResources.getString(R.string.Greek));
  ...
  public void onClickCheckBox(CheckBox checkBox, boolean isChecked) {
    ...
    if (checkBox.equals(mEnCbx)) {
      ...
      mPtBrCbx.setChecked(false, false);
      mElCbx.setChecked(false, false);
    ...
    } else if (checkBox.equals(mPtBrCbx)) {
      mEnCbx.setChecked(false, false);
      mFrCbx.setChecked(false, false);
      mDeCbx.setChecked(false, false);
      mEsCbx.setChecked(false, false);
      mElCbx.setChecked(false, false);
      onChangeLanguage(ExoConstants.BRAZIL_LOCALIZATION);
    } else if (checkBox.equals(mElCbx)) {
      mEnCbx.setChecked(false, false);
      mFrCbx.setChecked(false, false);
      mDeCbx.setChecked(false, false);
      mEsCbx.setChecked(false, false);
      mPtBrCbx.setChecked(false, false);
      onChangeLanguage(ExoConstants.GREEK_LOCALIZATION);
    }
