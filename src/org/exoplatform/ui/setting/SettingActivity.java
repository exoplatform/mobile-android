...
public class SettingActivity extends MyActionBar implements OnClickListener, CheckBox.ViewListener {
    ...
    private CheckBoxWithImage   mEnCbx, mFrCbx, mDeCbx, mEsCbx, mPtBrCbx;;
    ...
    private void initSubViews() {
        ...
        mFrCbx.setHeadImage(R.drawable.settingslanguagefrench).setViewListener(this);

        mDeCbx = (CheckBoxWithImage) findViewById(R.id.setting_de_ckb);
        mDeCbx.setText(mResources.getString(R.string.German));
        mDeCbx.setHeadImage(R.drawable.settingslanguagegerman).setViewListener(this);

        mEsCbx = (CheckBoxWithImage) findViewById(R.id.setting_es_ckb);
        mEsCbx.setText(mResources.getString(R.string.Spanish));
        mEsCbx.setHeadImage(R.drawable.settingslanguagespain).setViewListener(this);
        ...
        mPtBrCbx.setHeadImage(R.drawable.settingslanguagebrazil).setViewListener(this);
