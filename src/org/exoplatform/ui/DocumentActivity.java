...
public class DocumentActivity extends MyActionBar {
    ...
    public void onBackPressed() {
        ...
        if (_documentAdapter == null) {
            ...
            /*
             * Each time press on back button, return to parent folder and get
             * parents list file which is retrieved from 2 mapping dictionaries
             * {@link currentFileMap} and {@link childFileMap}
            ...
            if (_fileForCurrentActionBar.name.equals("")) {
                 ...
                 */
                _listViewDocument.setAnimation(AnimationUtils.loadAnimation(this,
