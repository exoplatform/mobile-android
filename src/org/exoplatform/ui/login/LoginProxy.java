...
public class LoginProxy implements CheckingTenantStatusTask.AsyncTaskListener,
    ...
    private void initStates(Bundle loginData) {
        ...
        /**
         * If any error happens, - redirect user to Login screen if not launched
         * from login - otherwise, dismiss the dialog
         */
    ...
    private void finish(int result) {
        ...
        case ExoConnectionUtils.LOGIN_SUSCESS:
            ...
            ArrayList<ServerObjInfo> serverList = ServerSettingHelper.getInstance()
        ...
        /** invoke listeners */
        if (mListener != null)
            mListener.onLoginFinished(result == ExoConnectionUtils.LOGIN_SUSCESS);
    }
