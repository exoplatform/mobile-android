package eXo.eXoPlatform.Activity.Dashboard;
...
import eXo.eXoPlatform.Activity.Home.eXoApplicationsController;
...
public class eXoGadgetViewController extends Activity {
      ...
      public View getView(int position, View convertView, ViewGroup parent) {
        ...
        rowView.setOnClickListener(new View.OnClickListener() {
          ...
          public void onClick(View v) {
            ...
            // AppController._eXoConnection.loginForStandaloneGadget(currentGadget._strGadgetUrl,
            // "demo", "gtn");
            ...
            try {
              ...
              if (status < 200 || status >= 300) {
                Toast.makeText(eXoGadgetViewController.this,
                               strConnectionTimedOut,
  ...
  public void changeLanguage(ResourceBundle resourceBundle) {
    ...
    try {
      // strTitleBar = new
      // String(resourceBundle.getString("SignInInformation").getBytes("ISO-8859-1"),
      // "UTF-8");
