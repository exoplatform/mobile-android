...
public class ComposeMessageActivity extends GDActivity implements
	...
	private void initCamera() {
		sdcard_temp_dir = Environment.getExternalStorageDirectory()
				+ File.separator + PhotoUltils.getDateFormat() + ".jpg";
	...
	private class AddPhotoDialog extends Dialog implements
