...
public class ActivityStreamDisplay extends GDActivity {
...
//  ArrayList<ActivityDisplayInfo> _arrActivity = new ArrayList<ActivityDisplayInfo>();
...
//        imageViewAvatar.setImageBitmap(activity._bmAvatar);
        ...
        textViewName.setText(mock.arrayOfActivityComments.get(position).statusID);
        
        TextView textViewMessage = (TextView) rowView.findViewById(R.id.textView_Message);
        textViewMessage.setText(mock.arrayOfActivityComments.get(position).title);
