...
public class SignInOnPremiseActivityTest extends ExoActivityTestUtils<SignInOnPremiseActivity> {
  ...
  public void createAndExpectHTTPRequests() {
    super.create();
    FakeHttp.addHttpResponseRule(getMatcherForRequest(REQ_PLATFORM_INFO), getResponseOKForRequest(REQ_PLATFORM_INFO));
    FakeHttp.addHttpResponseRule(getMatcherForRequest(REQ_JCR_USER), getResponseOKForRequest(REQ_JCR_USER));
    init();
  }
