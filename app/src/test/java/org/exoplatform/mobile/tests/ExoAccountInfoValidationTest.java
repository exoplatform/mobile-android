...
public class ExoAccountInfoValidationTest {
  ...
  public void testForbiddenTenantNames() {
    ...
    final String[] CLOUD_URLS_FORBIDDEN = { "http://exoplatform.net", "http://wks-acc.exoplatform.org",
  ...
  public void testShouldValidateCorrectEmails() {
    ...
    final String[] EMAILS_OK = { "test@example.com", "test.test@example.com", "test-test@example.com", "test_test@example.com",
        "test+test@example.com", "test@test.example.com", "test@test-example.com" };
  ...
  public void testShouldNotValidateIncorrectEmailsAndNull() {
    ...
    final String[] EMAILS_INCORRECT = { "example.com", "@example.com", "test", "test@", "test@.com" };
  ...
  public void testShouldValidateCorrectURLs() {
    ...
    final String[] URLS_OK = { "test.com", "test.example.com", "test-example.com", "test.fr", "test.info", "test.org",
        "test.net", "test.co.uk", "http://test.com", "https://test.com", "t.e.s.t.com", "10.100.10.1", "test.com:80",
        "test123.com", "www.test.com/some/path" };
  ...
  public void testShouldNotValidateIncorrectURLsAndNull() {
    ...
    final String[] URLS_INCORRECT = { "test.", ".com", "http://test{}.com", "https://test().com", "test[].com", "test!.com",
        "test@.com", "test#.com", "test$.com", "test&.com", "test*.com", "test|.com", "test~.com", "test example.com",
        "test_example.com", "http:test-example.org", "http//test-example.org", "0.0.0.0", "300.10.100.200", "test.10.20.30" };
  ...
  public void testShouldStripCorrectURLs() {
    ...
    String[] HTTP_URLS = { "test.com", "http://test.com", "test.com/some/long/path/", "http://test.com/shortpath/",
    ...
    String[] HTTPS_URLS = { "https://test.com", "https://test.com/some/long/path/", "https://test.com/shortpath/",
