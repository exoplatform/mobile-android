...
public class SectionListView extends ListView implements OnScrollListener {
  ...
  protected final void commonInitialisation() {
    ...
    autoLoadProgress.setPadding(0, 0, 0, 10); // 0px left, top and right, 10px
                                              // bottom
  ...
  public void setAdapter(final ListAdapter adapter) {
    if (!(adapter instanceof SectionListAdapter)) {
      throw new IllegalArgumentException("The adapter needds to be of type " + SectionListAdapter.class + " and is "
          + adapter.getClass());
    }
