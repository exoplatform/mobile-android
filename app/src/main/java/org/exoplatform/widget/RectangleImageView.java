...
public class RectangleImageView extends ImageView {
  ...
  private Bitmap getCachedBitmap(int width, int height) {
    if ((_bitmap != null) && (_bitmap.getWidth() == width) && (_bitmap.getHeight() == height))
      return _bitmap;
  ...
  private Canvas getCachedCanvas(int width, int height) {
    if (_canvasT != null)
      return _canvasT;
    Log.i("RectangleImageView", "create new canvas");
  ...
  private NinePatchDrawable getCachedNinePatchDrawable(int width, int height) {
    if ((_nicepatchDrawable != null) && (_nicepatchDrawable.getBounds().height() == height)
  ...
  protected void onDraw(Canvas canvas) {
    try {
      ...
      Log.e("RectangleImageView", e.getMessage());
    }
  }
}
