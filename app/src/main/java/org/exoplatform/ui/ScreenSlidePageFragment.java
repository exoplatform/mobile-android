...
public class ScreenSlidePageFragment extends Fragment {
  ...
  public static final int[]    SLIDER_IMGS           = { R.drawable.slide_activity_stream, R.drawable.slide_activity_details,
      R.drawable.slide_apps, R.drawable.slide_documents };

  public static final int[]    SLIDER_IMGS_PORTRAIT  = { R.drawable.slide_activity_stream_portrait,
      R.drawable.slide_activity_details_portrait, R.drawable.slide_apps_portrait, R.drawable.slide_documents_portrait };

  public static final int[]    SLIDER_IMGS_LANDSCAPE = { R.drawable.slide_activity_stream_land,
      R.drawable.slide_activity_details_land, R.drawable.slide_apps_land, R.drawable.slide_documents_land };
  ...
  private static final int[]   SLIDER_DESC           = { R.string.SliderDesc1, R.string.SliderDesc2, R.string.SliderDesc3,
  ...
  private static final String  TAG                   = ScreenSlidePageFragment.class.getName();
  ...
  public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    ViewGroup mRootView;
    if (mPageNumber != 0) {
      // Inflate the layout containing a title and body text - need to optimize
      // this one
